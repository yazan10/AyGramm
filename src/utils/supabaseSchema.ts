// AyGram Supabase SQL Schema definition
// Ready to copy & run directly in Supabase SQL Editor

export const AYGRAM_SUPABASE_SQL = `-- ==============================================================================
-- AyGram Complete Production Database Schema & Seed
-- منصة AyGram - البنية المتكاملة لقواعد البيانات للرفع والتشغيل على خوادم السحاب و Supabase
-- ==============================================================================
...
-- ==============================================================================
-- 1. جدول التخزين العام السريع للمزامنة الحية عبر السيرفر السحابي (aygram_storage)
